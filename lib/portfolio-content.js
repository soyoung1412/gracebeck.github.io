...
export const artPage = {
  ...
  photos: Array.from({ length: 17 }, (_, index) => {
    const padded = String(index + 1).padStart(2, "0");
    return {
      src: `/images/art-gallery-cornell/${padded}.png`,
      alt: `Cornell portfolio art page ${index + 1}`
    };
  })
};
...
export const aboutPage = {
  ...
  image: "/images/poster-grace.png",
  imageAlt: "Illustrated poster portrait created by Grace Beck",
  tags: ["PMA", "Colorgrading", "Art Background", "Asian Cinema"],
  notes: []
};
...
export const contactPage = {
  ...
  copy:
    "For posters, photography, film-set help, or creative collaborations, reach me here.",
  cards: [
    {
      title: "Best Fit",
