...
export const homeLandingPage = {
  ...
  imageAlt: "Baek Soyoung portrait poster",
  intro: [
...
export const posterWorksPage = {
  title: "Poster Works",
  intro:
    "A small page of posters and pieces that each carry a lot of personal meaning for me.",
  entries: [
    {
      eyebrow: "Poster 01",
...
export const artPage = {
  ...
  photos: [
    { src: "/images/art-gallery/01.jpg", alt: "Art page work 1" },
    { src: "/images/art-gallery/02.jpg", alt: "Art page work 2" },
    { src: "/images/art-gallery/03.jpg", alt: "Art page work 3" },
    { src: "/images/art-gallery/04.jpg", alt: "Art page work 4" },
    { src: "/images/art-gallery/05.jpg", alt: "Art page work 5" }
  ]
};
